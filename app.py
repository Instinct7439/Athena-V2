...
try:
    ...
    print(" Document comparison not available - document_comparison.py missing")
...
try:
    ...
    print(" Voice interface not available - voice_interface.py missing")
...
try:
    ...
    print(" Knowledge Graph + RAG not available")
